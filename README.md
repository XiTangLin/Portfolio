# Portfolio
## 2021 - Seoul Bikes Case Study (Coursework | R):
...
## 2021 - Brown Fat Case Study (Coursework | R)
...
## 2023 - GIS Assignments (Coursework | ArcGIS)
- A selection of geographic analysis: a suitability analysis and a routing analysis.
## 2023 - Solar Panel Report (Personal Project | R)
